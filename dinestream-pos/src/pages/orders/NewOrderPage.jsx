...
const handleConfirm = useCallback(async () => {
  try {
    const orderData = {
      tableId: selectedTable.id,  // ← DB id, not tableNumber
      notes,
      items: cartItems,
    }
...
}, [createOrder, selectedTable, cartItems, notes, navigate])
  // ────────────────────────────────────────────────────────────
  // RENDER
  // ────────────────────────────────────────────────────────────
  return (
            ...
            {tables.map(table => {
              ...
              return (
                <div
                  ...
                  style={{
                    background: isSelected ? '#f9731620'
                              : isAvailable ? '#111113' : '#0d0d0f',
                    border: `1px solid ${
                      isSelected  ? '#f97316'
                      : isAvailable ? '#ffffff0a' : '#ffffff05'
                    }`,
                    borderRadius: 12, padding: '18px 12px',
                    textAlign: 'center', cursor: isAvailable ? 'pointer' : 'not-allowed',
                  ...
                  onMouseLeave={e => {
                    if (!isSelected)
                      e.currentTarget.style.borderColor = isAvailable ? '#ffffff0a' : '#ffffff05'
                  }}
                >
          ...
          <div className="neworder-cart" style={{
            ...
            <button
              ...
              style={{
                ...
                boxShadow: cartItems.length > 0 ? '0 0 16px #f9731630' : 'none',
              }}
            >
          ...
          <div>
            ...
            <textarea
              ...
              style={{
                ...
                padding: '10px 12px', fontSize: 13, color: '#f4f4f5',
